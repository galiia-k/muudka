...
class Star_tracker:
    ...
    def __init__(self, nominal_quat: Quaternion, covariance_matrix: np.ndarray, delta_time: float):
        '''
    ...
    def Q_measured(self, t: float, Q_real: Quaternion) -> np.ndarray:
        ...
        if t - self.t_last >= self.delta_time:
            ...
            Q_measured = Q_real * self.quat_real * delta_quat * self.nominal_quat.conjugate
